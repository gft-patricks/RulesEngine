            ...
            foreach(var ruleFunc in ruleFuncList)
            {
                ...
                switch (operation)
                {
                    ...
                    case ExpressionType.AndAlso:
                        ...
                        if((_reSettings.NestedRuleExecutionMode ==  NestedRuleExecutionMode.Performance || operation == ExpressionType.AndAlso) && isSuccess == false)
                        {
                    ...
                    case ExpressionType.OrElse:
                        isSuccess = isSuccess || ruleResult.IsSuccess;
                        if ((_reSettings.NestedRuleExecutionMode == NestedRuleExecutionMode.Performance || operation == ExpressionType.OrElse) && isSuccess == true)
                        {
                            return (isSuccess, resultList);
                        }
                        break;
